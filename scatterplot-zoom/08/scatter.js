...
d3.csv(fileName, function(data) {
  ...
  queryUrl = 'http://mr-0xc8:55555/3/Frames/members_exemplar0?column_offset=0&column_count=10';
  ...
  function translateToAggregate (d) {
    var xTranslate = x(+exemplar[xCat]);
    var yTranslate = y(+exemplar[yCat]);
  ...
  function translateFromAggregateToDetail (d) {
    var xTranslate = x(d[xCat]);
    var yTranslate = y(d[yCat]);
    return 'translate(' + (xTranslate) + ',' + (yTranslate) + ')';
  }
